...
No fim, há um treinamento com a **taxa de aprendizado($\eta$): 0,5** e o uso de épocas(o ciclo feedforward -> erro -> backpropagation -> atualização dos pesos), em detalhes é basicamente o cálculo do gradiente na camada de saída (nesse caso $\sigma(z) \cdot (1 - \sigma(z))$) e faz um dot product com o erro, em notação matemática:
